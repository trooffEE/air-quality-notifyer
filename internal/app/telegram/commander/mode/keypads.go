...
const (
	...
	KeypadAskForDistrictOptionsText = "Район 🏘"
	KeypadAskForDistrictOptionsData = "set_operation_mode_district"
	KeypadSetHomeText               = "Дом 🏡"
	KeypadSetHomeData               = "set_operation_mode_home"
	KeypadBackText                  = "🌿 Вернуться к режимам работы"
)
